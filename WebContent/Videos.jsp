...
n=(String)session.getAttribute("Login_name");%>
 <%if (n != null){
	...
	<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<a href="vids/google.mp4" class="blog-img-holder" style="background-image: url(images/sp.jpg);"></a>
						<div class="blog-text">
							<h3><a href="vids/google.mp4">Sundar Pichai</a></h3>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="vids/vids1.mp4" class="blog-img-holder" style="background-image: url(images/vids1.png);"></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="vids/vids2.mp4" class="blog-img-holder" style="background-image: url(images/vids2.PNG);"></a>
						<div class="blog-text">
							<h3><a href="vids/vids2.mp4">Servlet Introduction</a></h3>
   ...
   <div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="vids/vids3.mp4" class="blog-img-holder" style="background-image: url(images/vids3.PNG);"></a>
						<div class="blog-text">
							<h3><a href="vids/vids3.mp4">Collection And Collections</a></h3>
...
<p>Collection is a top level interface of java collection framework where as Collections is an utility class. ArrayList, Vector, HashSet, LinkedHashSet, PriorityQueue are some indirect implementations of Collection interface. ..</p>						</div> 
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="vids/vids4.webm" class="blog-img-holder" style="background-image: url(images/vids4.PNG);"></a>
						<div class="blog-text">
							<h3><a href="vids/vids4.webm">Data Science</a></h3>
...
<p>Data science is a multi-disciplinary field that uses scientific methods, processes, algorithms and systems to extract knowledge and insights from structured and unstructured data.</p>						</div> 
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="vids/vids5.mp4" class="blog-img-holder" style="background-image: url(images/vids5.PNG);"></a>
						<div class="blog-text">
							<h3><a href="vids/vids5.mp4">The First Ever Robo Citizen-Sophia</a></h3>
...
<h1><b>UPLOAD COURSE</b><img src="pics/admin.png"></h1>
</div>
</div>
</div>
...
<div class="container">
	<div class="row row-pb-md">
			<div class="col-md-3 fh5co-widget">
				<h2>Upload File  <br><form name="myWebForm"  method="post"><br>
        <input type="hidden" name="MAX_FILE_SIZE" value="500" /><br>
