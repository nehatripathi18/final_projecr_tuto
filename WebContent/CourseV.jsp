...
n=(String)session.getAttribute("Login_name");%>
 <%if (n != null){
		...
		<center>
			...
			//	URL url=s.;
				...
				URL u=URL.class.getResource(s);
					...
					<%--  <input type="button" value='click here' onclick="window.location.href='file:///C:/Users/Training/VartikaWeb/2.pdf';">
					 <a href="Courses-PDF/<%=id1%>.pdf">read</a>  --%>
  ...
  <embed Path=s type="application/pdf" width="100%" height="500px" />
</object> -->	</div>
		</center>
